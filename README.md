...
- Through a *NodeMCU controller with a Joystick interface* we send UDP-based data against a websocketed, NodeJS Server.
- The NodeJS Server forwards the forwarded event-data to a *websocketed Godot Game* and reacts accordingly.
- For further reference, *we will reference soon the Madpong Game source code here (TBD)*.
